...
router.post("/mintNFT", authenticationMiddleware, async (req, res) => {
    ...
    try {
        ...
        You can download you warranty card in pdf format at <website-name>/user/getReceipt?mobile_no=${mobile_no}&serial_no=${serial_no}.
        To share Your NFT please visit <website-name>/user/sendNFT.
        Thank You`;
        try{
